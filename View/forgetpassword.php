    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 login-sec">
                ...
                <div class="copy-text">Shop Giày <i class="fa fa-heart"></i> <a
                        href="http://grafreez.com">shopgiay.com</a></div>
            </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img class="d-block img-fluid" src="Content/imagetourdien/9521597014227.png"
                                alt="First slide">

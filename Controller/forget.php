    ...
    case 'forget_action':
        if (isset($_POST['submit_email'])) {
            ...
            if ($checkuser > 0) {
                ...
                $mail->Username = "nhathuy26062004dz@gmail.com"; //
                // GMAIL password
                // $mail->Password = "php22023ngoc";
                $mail->Password = "otbj nogy pwtq qgpq"; //Phplytest20@php
                $mail->SMTPSecure = "tls";  // ssl
                // sets GMAIL as the SMTP server
                $mail->Host = "smtp.gmail.com";
                // set the SMTP port for the GMAIL server
                $mail->Port = "587"; // 465
                $mail->From = 'nhathuy26062004dz@gmail.com';
                $mail->FromName = 'Ly';
